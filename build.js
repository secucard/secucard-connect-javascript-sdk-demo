...
System.register('src/app/main', ['github:secucard/secucard-connect-javascript-client-lib@feature-browser-sdk/browser'], function (_export) {
  'use strict';

  var SecucardConnectBrowser, secuCardConnectBrowser;
  return {
    setters: [function (_githubSecucardSecucardConnectJavascriptClientLibFeatureBrowserSdkBrowser) {
      SecucardConnectBrowser = _githubSecucardSecucardConnectJavascriptClientLibFeatureBrowserSdkBrowser.SecucardConnectBrowser;
    }],
    execute: function () {
      secuCardConnectBrowser = new SecucardConnectBrowser();
